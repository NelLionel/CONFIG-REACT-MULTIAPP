                    ...
                    <div className="row">
                            ...
                            <div className="card">
                                <div className="card-header p-0 position-relative">
                                    <a href="#course-single" className="zoom d-block">
                                        <img className="card-img-bottom d-block" src="assets/public/images/c1.jpg"
                                            alt="Card cap" />
                                    </a>
                                ...
                                <div className="card-footer">
                                    <div className="author align-items-center">
                                        <img src="assets/public/images/a1.jpg" alt="" className="img-fluid rounded-circle" />
                        ...
                        <div className="col-lg-4 col-md-6 item mt-md-0 mt-5">
                            <div className="card">
                                <div className="card-header p-0 position-relative">
                                    <a href="#course-single" className="zoom d-block">
                                        <img className="card-img-bottom d-block" src="assets/public/images/c5.jpg"
                                            alt="Card cap" />
                                    </a>
                                ...
                                <div className="card-footer">
                                    <div className="author align-items-center">
                                        <img src="assets/public/images/a2.jpg" alt="" className="img-fluid rounded-circle" />
                                        <ul className="blog-meta">
                                            <li>
                        ...
                        <div className="col-lg-4 col-md-6 item mt-lg-0 mt-5">
                            <div className="card">
                                <div className="card-header p-0 position-relative">
                                    <a href="#course-single" className="zoom d-block">
                                        <img className="card-img-bottom d-block" src="assets/public/images/c6.jpg"
                                            alt="Card cap" />
                                    </a>
                                ...
                                <div className="card-footer">
                                    <div className="author align-items-center">
                                        <img src="assets/public/images/a4.jpg" alt="" className="img-fluid rounded-circle" />
                                        <ul className="blog-meta">
                                            <li>
                    ...
                    <div className="col-md-6">
                        <div className="top-pic1">
                            <div className="card-body blog-details">
                                ...
                                <div className="author align-items-center">
                                    <img src="assets/public/images/team1.jpg" alt="blogs" className="img-fluid rounded-circle" />
                                    <ul className="blog-meta">
                                        <li>
                    ...
                    <div className="col-md-6 mt-md-0 mt-4">
                        <div className="top-pic2">
                            <div className="card-body blog-details">
                                ...
                                <div className="author align-items-center">
                                    <img src="assets/public/images/team2.jpg" alt="" className="img-fluid rounded-circle" />
                                    <ul className="blog-meta">
                                        <li>
                        ...
                        <div className="mt-4">
                            <div className="top-pic3">
                                <div className="card-body blog-details">
                                    ...
                                    <div className="author align-items-center">
                                        <img src="assets/public/images/team3.jpg" alt="" className="img-fluid rounded-circle" />
                                        <ul className="blog-meta">
                                            <li>
                        ...
                        <div className="col-lg-7 feature-grid-right mt-lg-0 mt-5">
                            <div className="row">
                                <div className="col-sm-6">
                                    <div className="box16">
                                        <a href="#url">
                                            <img src="assets/public/images/team1.jpg" alt="" className="img-fluid radius-image" />
                                        </a>
                                ...
                                <div className="col-sm-6 mt-sm-0 mt-3">
                                    <div className="box16">
                                        <a href="#url">
                                            <img src="assets/public/images/team2.jpg" alt="" className="img-fluid radius-image" />
                                        </a>
                                        <div className="box-content">
                                            <h3 className="title">
                                ...
                                <div className="col-sm-6 mt-lg-4 mt-3">
                                    <div className="box16">
                                        <a href="#url">
                                            <img src="assets/public/images/team3.jpg" alt="" className="img-fluid radius-image" />
                                        </a>
                                        <div className="box-content">
                                            <h3 className="title">
                                ...
                                <div className="col-sm-6 mt-lg-4 mt-3">
                                    <div className="box16">
                                        <a href="#url"><img src="assets/public/images/team4.jpg" alt=""
                                    ...
                                    <div className="testimonial">
                                        ...
                                        <div className="testi-des">
                                            <div className="test-img">
                                                <img src="assets/public/images/team1.jpg" className="img-fluid"
                                                    alt="client-img" />
                                            </div>
                            ...
                            <div className="item">
                                <div className="testimonial-content">
                                    <div className="testimonial">
                                        ...
                                        <div className="testi-des">
                                            <div className="test-img"><img src="assets/public/images/team2.jpg" className="img-fluid"
                                                    alt="client-img" />
                                            </div>
                                            <div className="peopl align-self">
                                                <h3>Julia sakura</h3>
                            ...
                            <div className="item">
                                <div className="testimonial-content">
                                    <div className="testimonial">
                                        ...
                                        <div className="testi-des">
                                            <div className="test-img"><img src="assets/public/images/team3.jpg" className="img-fluid"
                                                    alt="client-img" />
                                            </div>
                                            <div className="peopl align-self">
                                                <h3>Roy Linderson</h3>
                            ...
                            <div className="item">
                                <div className="testimonial-content">
                                    <div className="testimonial">
                                        ...
                                        <div className="testi-des">
                                            <div className="test-img"><img src="assets/public/images/team4.jpg" className="img-fluid"
                                                    alt="client-img" />
                                            </div>
                                            <div className="peopl align-self">
                                                <h3>Mike Thyson</h3>
                    ...
                    <div className="company-logos text-center">
                        <div className="row logos">
                            <div className="col-lg-2 col-md-3 col-4">
                                <img src="assets/public/images/brand1.png" alt="" className="img-fluid" />
                            </div>
                            <div className="col-lg-2 col-md-3 col-4">
                                <img src="assets/public/images/brand2.png" alt="" className="img-fluid" />
                            </div>
                            <div className="col-lg-2 col-md-3 col-4">
                                <img src="assets/public/images/brand3.png" alt="" className="img-fluid" />
                            </div>
                            <div className="col-lg-2 col-md-3 col-4 mt-md-0 mt-4">
                                <img src="assets/public/images/brand4.png" alt="" className="img-fluid" />
                            </div>
                            <div className="col-lg-2 col-md-3 col-4 mt-lg-0 mt-4">
                                <img src="assets/public/images/brand5.png" alt="" className="img-fluid" />
                            </div>
                            <div className="col-lg-2 col-md-3 col-4 mt-lg-0 mt-4">
                                <img src="assets/public/images/brand6.png" alt="" className="img-fluid" />
                            </div>
                        </div>
                    </div>
                </div>
