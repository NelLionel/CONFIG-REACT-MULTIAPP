...
import BreadCrumps from "../../components/public-section/BreadCrumps";
                ...
                <div class="card">
                  <div class="card-header p-0 position-relative">
                    <a href="#course-single" class="zoom d-block">
                      <img
                        ...
                        src="assets/public/images/c1.jpg"
                        alt="Card cap"
                      />
                    </a>
                    <div class="post-pos">
                  ...
                  <div class="card-footer">
                    <div class="author align-items-center">
                      <img
                        src="assets/public/images/a1.jpg"
                        alt=""
                ...
                <div class="card">
                  <div class="card-header p-0 position-relative">
                    <a href="#course-single" class="zoom d-block">
                      <img
                        class="card-img-bottom d-block"
                        src="assets/public/images/c2.jpg"
                        alt="Card cap"
                      />
                    </a>
                  ...
                  <div class="card-footer">
                    <div class="author align-items-center">
                      <img
                        src="assets/public/images/a2.jpg"
                        alt=""
                        class="img-fluid rounded-circle"
                      />
                      <ul class="blog-meta">
                ...
                <div class="card">
                  <div class="card-header p-0 position-relative">
                    <a href="#course-single" class="zoom d-block">
                      <img
                        class="card-img-bottom d-block"
                        src="assets/public/images/c3.jpg"
                        alt="Card cap"
                      />
                    </a>
                  ...
                  <div class="card-footer">
                    <div class="author align-items-center">
                      <img
                        src="assets/public/images/a3.jpg"
                        alt=""
                        class="img-fluid rounded-circle"
                      />
                      <ul class="blog-meta">
                ...
                <div class="card">
                  <div class="card-header p-0 position-relative">
                    <a href="#course-single" class="zoom d-block">
                      <img
                        class="card-img-bottom d-block"
                        src="assets/public/images/c4.jpg"
                        alt="Card cap"
                      />
                    </a>
                    <div class="post-pos">
                  ...
                  <div class="card-footer">
                    <div class="author align-items-center">
                      <img
                        src="assets/public/images/a4.jpg"
                        alt=""
                        class="img-fluid rounded-circle"
                      />
                      <ul class="blog-meta">
                ...
                <div class="card">
                  <div class="card-header p-0 position-relative">
                    <a href="#course-single" class="zoom d-block">
                      <img
                        class="card-img-bottom d-block"
                        src="assets/public/images/c5.jpg"
                        alt="Card cap"
                      />
                    </a>
                    <div class="course-price-badge"> Free</div>
                ...
                <div class="card">
                  <div class="card-header p-0 position-relative">
                    <a href="#course-single" class="zoom d-block">
                      <img
                        class="card-img-bottom d-block"
                        src="assets/public/images/c6.jpg"
                        alt="Card cap"
                      />
                    </a>
                    <div class="course-price-badge-new"> New</div>
